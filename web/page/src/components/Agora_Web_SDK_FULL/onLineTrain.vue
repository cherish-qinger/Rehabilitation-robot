...
<!--        <p class="player-name">医生：(${uid})</p>-->
        <p id="local-player-name" class="player-name" style="width: 100%"></p>
        <div id="local-player" class="player" style="width: 80%; margin-left: 10%"></div>
      </div>
      <div id="remote-playerlist" style="width: 48%"></div>
<!--      <div class="w-100" style="float : right;width: 350px"></div>-->
<!--      <div class="col" style="float : right;width: 350px">-->
<!--        <div id="remote-playerlist" style="width: 350px"></div>-->
<!--      </div>-->
    </div>
  ...
  methods: {
    initAgora() {
      ...
      this.rtc = {
        ...
        localVideoTrack: null, localStream: null,
        remoteStreams: [],
      ...
      async showlist() {
          ...
          var that=this;
          $(".cam-list").delegate("a", "click",  function () {
            that.switchCamera(this.innerText);
          });
          $(".mic-list").delegate("a", "click", function() {
      ...
      $("#local-player-name").text(`患者(${this.localname})`);
...
<!--        <p class="player-name">remoteUser(${uid})</p>-->
        <p class="player-name">医生：(${this.remoteUsers[uid].name})</p>
    ...
    handleUserPublished(user, mediaType) {
      ...
      request({
        ...
        if(res.data.code===500){
          ...
          this.remoteUsers[id]['name']=res.data.data.dname;
